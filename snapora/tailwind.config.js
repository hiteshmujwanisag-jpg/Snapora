  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        playfair: ["PlayfairRegular"],
        playfairBold: ["PlayfairBold"],
        playfairMedium: ["PlayfairMedium"],
        playfairSemiBold: ["PlayfairSemiBold"],
        dm: ["DMSansRegular"],
        dmMedium: ["DMSansMedium"],
        dmSemi: ["DMSans-SemiBold"],
        dmBold: ["DMSansBold"],
        dmItalic: ["DMSansItalic"],
        dmMediumItalic: ["DMSansMediumItalic"],
        dmSemiItalic: ["DMSansSemiBoldItalic"],
        dmBoldItalic: ["DMSansBoldItalic"],
      },
      fontWeight: {
        extrablack: "950",
      },
